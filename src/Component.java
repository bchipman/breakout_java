...
public class Component extends JComponent {
    ...
    private class MyMouseInputListener implements MouseInputListener {
        ...
        public void mouseExited(MouseEvent e) {
            Paddle[] updatedPaddles = paddle.movePaddle(ball, new Point2D.Double(paddle.x, paddle.y));
        ...
        public void mouseMoved(MouseEvent e) {
            Paddle[] updatedPaddles = paddle.movePaddle(ball, new Point2D.Double(e.getX(), Globals.PADDLE_Y_POSITION));
            oldPaddle = updatedPaddles[0];
            paddle = updatedPaddles[1];
            unionPaddle = updatedPaddles[2];
